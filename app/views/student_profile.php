    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .parallax-bg {
            ...
            background: url('https://picsum.photos/seed/student-desk-study/1920/1080.jpg') center/cover no-repeat;
        ...
        .info-row:hover .info-icon-box i {
            color: #60A5FA;
        }
        .info-icon-box {
        ...
        @media (max-width: 640px) {
            ...
            .info-row:hover { padding-left: 0; }
            .parallax-header { min-height: 280px; height: 40vh; }
        }
    </style>
</head>
<body>
    ...
    <!-- Fixed Back Button — ORIGINAL LINK -->
    <a href="<?= site_url('student') ?>" class="back-float" id="backBtn">
    ...
    <section style="padding: 0 24px 80px; position: relative; margin-top: -40px; z-index: 20;">
        <div style="max-width: 680px; margin: 0 auto;">
            ...
            <!-- Main Glass Card -->
            <div class="glass-card reveal-scale" style="padding: 48px; position: relative; overflow: hidden;">
                ...
                <div class="profile-header-flex" style="display:flex; align-items:center; gap:24px; margin-bottom:40px; position:relative; z-index:1;">
                ...
                <!-- ORIGINAL DATA ROWS — each <p> mapped to an info row -->
                <div style="position: relative; z-index: 1;">

                    <!-- Student ID -->
                    <div class="info-row reveal-up" style="transition-delay:0s;">
                    ...
                    <!-- Name -->
                    <div class="info-row reveal-up" style="transition-delay:0.05s;">
                        <div class="info-icon-box">
                    ...
                    <!-- Course -->
                    <div class="info-row reveal-up" style="transition-delay:0.1s;">
                        <div class="info-icon-box">
                    ...
                    <!-- Year Level -->
                    <div class="info-row reveal-up" style="transition-delay:0.15s;">
                        <div class="info-icon-box">
                    ...
                    <!-- Section -->
                    <div class="info-row reveal-up" style="transition-delay:0.2s;">
                        <div class="info-icon-box">
                    ...
                    <!-- Email -->
                    <div class="info-row reveal-up" style="transition-delay:0.25s;">
                        <div class="info-icon-box">
                            <i data-lucide="mail"></i>
                        </div>
                        <div>
                            <div class="info-label">Email Address</div>
                            <div class="info-value" style="font-family:'Inter',sans-serif;font-size:15px;font-weight:400;"><?= $email ?></div>
                        </div>
                    </div>
            ...
            <!-- Bottom Back Button — ORIGINAL LINK -->
            <div style="text-align:center; margin-top:40px;" class="reveal-up">
                <a href="<?= site_url('student') ?>" class="glass-btn">
    ...
    <footer class="footer-glass" style="padding: 32px 24px;">
        <div style="max-width: 680px; margin: 0 auto; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 12px;">
            <span style="
                font-family: 'Space Grotesk', sans-serif;
